...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Tedy</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
           Passionate about building <span className="heroShiny1 text-fun-pink"> web interfaces</span> with{" "}  interest in
          <span className="heroShiny2 text-fun-pink"> backend ,QA and machine learning.</span>
          <img
        ...
        <ScrollLink
          ...
          duration={500}
        >
          <div className="cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white border border-white/20 text-xl rounded-full bg-white/5 backdrop-blur-md hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-all duration-300 shadow-xl">
            Tell me more
          </div>
        </ScrollLink>
      </div>
